...
CUDA_VISIBLE_DEVICES=2 python main.py @argfiles/ablation/biglstm_rgcn_attn_2rels_nomask_750_0.6.txt > ./logs/ablation/biglstm_rgcn_attn_gate_2rels_nomask_750_0.6_$(date +"%Y_%m_%d_%I_%M_%S").log
CUDA_VISIBLE_DEVICES=3 python main.py @argfiles/ablation/biglstm_rgcn_attn_1rel_nomask_adjseq.txt > ./logs/ablation/biglstm_rgcn_attn_1rel_nomask_adjseq_$(date +"%Y_%m_%d_%I_%M_%S").log